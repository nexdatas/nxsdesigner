...
# dialog defining a vds tag
class VDSDlg(NodeDlg):

    # constructor
    # \param parent patent instance
    def __init__(self, parent=None):
        super(VDSDlg, self).__init__(parent)
    ...
    # provides the state of the vds dialog
    # \returns state of the vds in tuple
    def getState(self):
    ...
    # sets the state of the vds dialog
    # \param state vds state written in tuple
    ...
    # adds an attribute
    #  \brief It runs the VDS Dialog and fetches attribute name and value
    ...
    # changing dimensions of the vds
    ...
    # \brief It copies the vds name and type from lineEdit widgets
...
It should be defined by client."""
    ...
    app.exec_()
    if form.name:
        logger.info("VDS: name = \'%s\'" % (form.name))
    if form.nexusType:
